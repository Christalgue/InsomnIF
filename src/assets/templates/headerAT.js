        ...
        <div class="container">\
            <div class="row align-middle">\
                ...
                <div class="col-4 text-center pr-0 align-middle">\
                    <button  onclick="window.location=\'file:///Users/yhua/Desktop/IHM/insomnif/src/assets/templates/ListeArchetypes.html\';"class="border-right-0 border-top-0 border-left-0 bg-white" style="border-bottom: 2px solid grey;">Archetype</button>\
                </div>\
            </div>\
        </div>\
    </body>\
